            ...
            <div className="bg-[#222222] border border-border rounded-xl p-6 h-full flex flex-col">
                ...
                <div className="mb-6">
                    ...
                    <div className="flex items-center gap-2 text-text-muted text-sm bg-[#1A1A1A] p-3 rounded-lg">
                        ...
                        <span className="text-text-white font-medium flex-1">DNS: {dnsAddress}</span>
                        <button
                            onClick={() => copyToClipboard(dnsAddress)}
                            className="text-xs bg-[#00FF26]/10 text-[#00FF26] px-2 py-1 rounded-md hover:bg-[#00FF26]/20 transition-colors flex items-center gap-1 flex-shrink-0"
                            title="Copy DNS"
                        >
                ...
                <div className="space-y-3 flex-1">
                    ...
                    {stratumAddresses.map((address, index) => (
                        <div key={index} className="flex items-start sm:items-center gap-2 bg-[#1A1A1A] p-3 rounded-lg">
                            {/* Bitcoin icon */}
                            <svg width="16" height="16" viewBox="0 0 271.64 277.95" className="flex-shrink-0 mt-0.5 sm:mt-0">
                                <path fill="#52cbca"
                            ...
                            <span className="text-text-primary text-sm font-mono flex-1 break-all leading-tight">
                                {address}
                            </span>
                            ...
                            <button
                                ...
                                className="text-xs bg-[#00FF26]/10 text-[#00FF26] px-2 py-1 rounded-md hover:bg-[#00FF26]/20 transition-colors flex items-center gap-1 flex-shrink-0 mt-0.5 sm:mt-0"
                                title="Copy address"
                            >
