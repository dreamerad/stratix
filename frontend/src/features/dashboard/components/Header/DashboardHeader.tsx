...
export function DashboardHeader() {
  ...
  {userData?.name || 'User'}
                            ...
                            >
                                <path d="M5 7.5L10 12.5L15 7.5" stroke="#7A7A7A" strokeWidth="1.5" strokeLinecap="round"
                        ...
                        {isUserMenuOpen && (
                            <div
                                className="absolute w-[280px] right-0 top-full mt-2 w-56 bg-primary-card  rounded-lg shadow-xl z-50 animate-scaleIn">
