                    ...
                    <div className="max-w-[800px] mx-auto space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                            <div className="space-y-2">
                                                <label className="block text-text-muted text-sm flex items-center gap-2">
                                                    <svg width="24" height="24" viewBox="0 0 271.64 277.95" className="flex-shrink-0">
                        ...
                        <div className="bg-[#222222] rounded-lg p-6 border border-border">
                            ...
                            <div className="space-y-6">
                                    ...
                                    <div key={account.id} className="bg-primary-bg border border-border rounded-lg p-6">
                                        ...
                                        <div className="space-y-4">
                                            {account.fees.map((fee, feeIndex) => (
                                                <div key={feeIndex} className="bg-[#1A1A1A] border border-border/50 rounded-lg p-4">
                                                    <div className="flex items-center justify-between mb-4">
                                                        <h4 className="text-text-primary font-medium">Fee #{feeIndex + 1}</h4>
                                                        <button
                                            ...
                                            {account.fees.length === 0 && (
                                                <div className="text-center py-4 text-text-muted">
                                                    <p className="text-sm opacity-60">Нажмите "Добавить fee" выше для добавления настроек</p>
                                                </div>
                                            )}
                                        </div>
                                    </div>
                                ...
                                {accounts.length === 0 && (
                                    <div className="text-center py-4 text-text-muted">
                                        <p className="text-sm opacity-60">Нажмите "Добавить аккаунт" выше для создания первого аккаунта</p>
                                    </div>
                                )}
                            </div>
                        </div>
